...
## Working of project
1. We fetch the restaurants of your city from Swiggy API(now hard-coded due to change in api), getting the live data.
...
5. Add feature to search different cities, currently working for particular city only.
